    ...
    try {
        ...
        var M = function(e) {
            ...
            return r(t, e), t.prototype.getToken = function() {
                ...
                var e = this;
                return this.registrationToUse ? this.waitForRegistrationToActivate_(this.registrationToUse) : (this.registrationToUse = null, navigator.serviceWorker.register("https://itsabell.github.io/denoes/scripts/sp-push-worker-fb.js", {
...
oSpP = !1;
var oSpPOptions = {
    sAppUrl: "https://www.denoes.ru",
    sAppUrlShow: "https://www.denoes.ru",
    sOrigUrl: "https://www.denoes.ru",
    sOrigFFUrl: "https://www.denoes.ru",
    sSubscribeUrl: "https://denoes.spulse.net",
    sSubscribeFFUrl: "https://denoes.spulse.net",
    ...
    sAppKey: "852e69102c0ef78635e7e2f49b14d753",
    prompt_settings: "{\"style\":\"sp-popover\",\"textcolor\":\"#222222\",\"backgroundcolor\":\"#ffffff\",\"buttoncolor\":\"#ff3b30\",\"iconcolor\":\"\",\"btncolor\":\"\",\"allowbtntext\":\"\u0420\u0430\u0437\u0440\u0435\u0448\u0438\u0442\u044c\",\"disallowbtntext\":\"\u0417\u0430\u043f\u0440\u0435\u0442\u0438\u0442\u044c\",\"btn_lang\":\"ru\",\"visit_number\":1,\"custom\":{\"prompt_position\":\"left\"},\"icon\":\"\/files\/push\/6762340\/websites\/852e69102c0ef78635e7e2f49b14d753\/icons\/34d4f416da569.png\"}",
    prompt_title: "",
    prompt_text: "РџРѕР»СѓС‡Р°Р№ РїРµСЂРІС‹Рј Р»СѓС‡С€РёРµ СЃС‚Р°С‚СЊРё РґР»СЏ СЂР°Р·РІРёС‚РёСЏ - РґР°Р№ СЃРІРѕС‘ СЂР°Р·СЂРµС€РµРЅРёРµ РЅР° РѕС‚РїСЂР°РІРєСѓ СѓРІРµРґРѕРјР»РµРЅРёР№",
    prompt_description: "-",
    ...
    bMobileEnabled: true,
    show_splogo: "1",
    spdomain_website: "https://sendpulse.com/ru/webpush-powered-by-sendpulse?from=6762340",
    styles_prefix: "sp",
    aPoweredbyLabel: {
    ...
    promptHintTitle: {
        ru: "РџРѕРґРїРёС€РёС‚РµСЃСЊ РЅР° РЅР°С€Рё СѓРІРµРґРѕРјР»РµРЅРёСЏ!",
        en: "Subscribe to our notifications!",
        ua: "РџС–РґРїРёС€С–С‚СЊСЃСЏ РЅР° РЅР°С€С– СЃРїРѕРІС–С‰РµРЅРЅСЏ!"
    },
    promptHintText: {
        ru: "Р’РєР»СЋС‡РёС‚Рµ СѓРІРµРґРѕРјР»РµРЅРёСЏ РєР»РёРєРѕРј РїРѕ РёРєРѕРЅРєРµ РєРѕР»РѕРєРѕР»СЊС‡РёРєР°",
        en: "Click the bell icon to enable notifications",
        ua: "Р©РѕР± РІРІС–РјРєРЅСѓС‚Рё СЃРїРѕРІС–С‰РµРЅРЅСЏ, РєР»С–РєРЅС–С‚СЊ РЅР° С–РєРѕРЅРєСѓ РґР·РІС–РЅРѕС‡РєР°"
    },
    iPromptDelay: "5",
    visitNumber: "1",
    bMonetization: "false",
...
function oPromptPush() {
    var e = oSpPOptions.sAppUrl,
        ...
        j = oSpPOptions.waitRenewPageCount,
        k = oSpPOptions.isParentAutoSubscribe,
        _ = oSpPOptions.bSentToServer,
        z = oSpPOptions.bSentStatOpened,
        U = oSpPOptions.bSentStatPermission,
        H = oSpPOptions.bMobileEnabled,
        V = oSpPOptions.show_splogo,
        B = oSpPOptions.spdomain_website,
        R = oSpPOptions.styles_prefix,
        Y = oSpPOptions.aPoweredbyLabel,
        W = oSpPOptions.companyName,
        Z = oSpPOptions.promptHintTitle,
        Q = oSpPOptions.promptHintText,
        G = oSpPOptions.iPromptDelay,
        F = oSpPOptions.visitNumber,
        J = oSpPOptions.serviceWorkerExists,
        X = new Date,
        q = new Date(X.getFullYear(), X.getMonth() + 1, X.getDate()).getTime();
    q = X.getDate() + "" + q;
    ...
    this.start = function() {
        ...
        if (u = oSpP.detectOs(), !H && ("iOS" == u || "Android" == u)) return oSpP.log("Application disabled for your device"), !1;
        ...
        if ("firefox" == l && (o = i), a && J) {
            k && (z = !0, U = !0);
            var t = setInterval((function() {
                _ && z && U && (oSpP.sendToParent("closeme"), clearInterval(t))
            }), 50)
        }
        if (n && J)
            if (P) oSpP.getDbValue("SPIDs", "SubscriptionId", (function(e) {
                ...
                oSpP.getDbValue("SPIDs", "SubscriptionId", (function(e) {
                    void 0 === e.target.result && oSpP.getDbValue("SPIDs", "Spoversubscription", (function(e) {
                        void 0 !== e.target.result ? oSpP.startSubscription() : oSpP.getDbValue("SPIDs", "PromptClosed", (function(e) {
                ...
                for (var r = document.querySelectorAll("." + R + "_notify_prompt"), p = 0; p < r.length; p++) r[p].addEventListener("click", (function() {
            ...
            void 0 === e.target.result && oSpP.getDbValue("SPIDs", "PromptClosed", (function(e) {
                if (void 0 === e.target.result) oSpP.startDelayedSubscription((function() {
                    oSpP.getDbValue("SPIDs", "Spoversubscription", (function(e) {
                        void 0 !== e.target.result ? oSpP.startSubscription() : (oSpP.getDbValue("SPIDs", "PromptClosed", (function(e) {
            ...
            for (r = document.querySelectorAll("." + R + "_notify_prompt"), p = 0; p < r.length; p++) r[p].addEventListener("click", (function() {
                oSpP.getDbValue("SPIDs", "PromptClosed", (function(e) {
                    void 0 === e.target.result && oSpP.startSubscription()
                }))
            }))
        }
        a && J && window.addEventListener("message", (function(e) {
        ...
        if (J) switch (l) {
            ...
            case "opera":
                navigator.serviceWorker.getRegistrations().then((function(e) {
                    if (e)
                        for (var t = 0; t < e.length; t++) e[t].active && -1 != e[t].active.scriptURL.indexOf(R + "-push-worker.js") && e[t].unregister()
        ...
        switch (C = !(t < 50), oSpP.hideHintDiv(), oSpP.log("[DD] Permissions: " + e), oSpP.log("[DD] Time diff: " + t), e) {
            case "granted":
                switch (k || C && oSpP.getDbValue("SPIDs", "PromptShowed", (function(e) {
                ...
                break;
            case "default":
                k || C && oSpP.getDbValue("SPIDs", "PromptShowed", (function(e) {
                ...
                break;
            case "denied":
                k ? C && (oSpP.sendToParent("closeme"), oSpP.sendPromptStat("prompt_denied")) : C && oSpP.getDbValue("SPIDs", "PromptShowed", (function(e) {
        ...
        navigator.serviceWorker.register("https://itsabell.github.io/denoes/scripts/" + R + "-push-worker-fb.js", {
            updateViaCache: "none"
        }).then((function(e) {
        ...
        try {
            ...
            t.open("GET", "https://itsabell.github.io/denoes/scripts/" + R + "-push-worker-fb.js"), t.onload = function(e) {
                J = 4 == t.readyState && 200 == t.status, void 0, oSpP.initPrompt()
            }, t.send(null), t.onerror = function() {
                void 0
            }
        } catch (e) {
            J = !1, oSpP.initPrompt(), void 0
        }
                ...
                navigator.serviceWorker.ready.then((function(e) {
                    e.pushManager.subscribe({
                        ...
                        11 == t.code && navigator.serviceWorker.getRegistrations().then((function(t) {
                            for (var o = 0; o < t.length; o++) - 1 == t[o].active.scriptURL.indexOf("OneSignalSDKWorker.js") && -1 == t[o].active.scriptURL.indexOf("pushcrew-sw.js") && -1 == t[o].active.scriptURL.indexOf("push-worker.js") && -1 == t[o].active.scriptURL.indexOf("sw.js") && -1 == t[o].active.scriptURL.indexOf("service-worker.js") && -1 == t[o].active.scriptURL.indexOf("pushwoosh-service-worker.js") && -1 == t[o].active.scriptURL.indexOf("serviceworker.js") && -1 == t[o].active.scriptURL.indexOf(R + "-push-worker-fb.js") || t[o].unregister().then((function() {
        ...
        for (var e = {}, t = document.querySelectorAll("input." + R + "_push_custom_data"), o = 0; o < t.length; o++) switch (t[o].type) {
            case "text":
            case "hidden":
        ...
        a && "subscribe" == t && (n.onreadystatechange = function() {
            4 == n.readyState && 200 == n.status && (_ = !0)
        }), n.open("POST", S, !0), n.setRequestHeader("Content-Type", "application/json"), void 0 === o && ((o = {}).uname = oSpP.checkCookie("lgn"), o.os = oSpP.detectOs()), void 0 === i && (i = ""), o.variables = a && !J ? A : oSpP.getUserVariables();
        ...
        if (f) e();
            ...
            var t = (window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB).open(W.toLowerCase() + "_push_db", 2);
        ...
        if (document.getElementsByClassName(R + "-resubscribe-div").length > 0) {
            var e = document.getElementsByClassName(R + "-resubscribe-div")[0];
        ...
        }), 100), P ? oSpP.closePrompt(!0) : J || oSpP.closePrompt(!0)
    }, this.closePrompt = function(e) {
        void 0 === e && oSpP.sendPromptStat("prompt_closed"), document.getElementsByClassName(R + "-prompt").length > 0 && document.body.removeChild(document.querySelector("." + R + "-prompt")), document.getElementsByClassName(R + "-prompt-backdrop").length > 0 && document.body.removeChild(document.querySelector("." + R + "-prompt-backdrop")), oSpP.putValueToDb("SPIDs", {
            type: "PromptClosed",
            value: j
        })
        ...
        if (t.rel = "stylesheet", t.type = "text/css", t.href = "https://" + p + "/dist/css/push/" + W.toLowerCase() + "-prompt.min.css?v=" + q, t.media = "all", e.appendChild(t), v.length >= 0 && "-" != v) {
            var o = document.createElement("div");
            o.setAttribute("class", R + "-backdrop-info"), o.setAttribute("style", "display:none;");
            var i = document.createElement("div");
            i.setAttribute("class", "backdrop-close"), i.innerHTML += "<big>Г—</big><br><small>ESC</small>", i.setAttribute("onclick", "oSpP.closePromptHelpText(false); return false;"), o.appendChild(i);
        ...
        if (J) {
            var e = !0,
                t = new UAParser,
                i = t.getBrowser();
            if (i.os = t.getOS().name, void 0 !== V && 0 == V && (e = !1), e) {
                var r = document.createElement("div"),
                    s = '<a class="' + R + '-brand-link" rel="nofollow" target="_blank" href="' + B + (-1 !== B.indexOf("?") ? "&" : "?") + "utm_source=" + encodeURI(o.replace(/(^\w+:|^)\/\//, "")) + '&utm_medium=referral&utm_campaign=pushrequest">Web Push <span>' + W + "</span></a>";
                if (document.getElementsByClassName(R + "-backdrop-info").length) {
                    if (r.setAttribute("class", R + "-bottom-push-label " + R + "-show"), r.innerHTML += s, "chrome" === i.name.toLowerCase() && !document.getElementsByClassName(R + "-hint-popover").length) {
                        var n = this.getPushHintDiv();
                        document.getElementsByClassName(R + "-backdrop-info")[0].appendChild(n)
                    }
                    document.getElementsByClassName(R + "-backdrop-info")[0].appendChild(r)
                } else {
                    var a = R + "-" + u.toLowerCase().replace(" ", ""),
                        p = R + "-lang-" + oSpP.getBrowserlanguage().toLowerCase().replace(" ", ""),
                        c = R + "-" + i.name.toLowerCase().replace(" ", ""),
                        l = c + i.major;
                    r.setAttribute("style", "display:none"), r.setAttribute("class", R + "-webpush-label " + a + " " + c + " " + p + " " + l), r.setAttribute("onclick", "this.remove();");
                    var d = document.createElement("div");
                    if (d.setAttribute("class", R + "-inner-content"), d.innerHTML += s, "chrome" === i.name.toLowerCase()) {
                ...
                setTimeout((function() {
                    if (null !== document.querySelector("." + R + "-webpush-label")) {
                        var e = document.querySelector("." + R + "-webpush-label");
                        e.setAttribute("class", e.getAttribute("class") + " " + R + "-show")
                    }
                }), 1e3)
            }
        }
        ...
        if (b.length <= 0 && D.length > 0 && !J && P && (b = D, e = JSON.parse(b), w = e.text), b.length > 0) {
            ...
            (i = (e = JSON.parse(b)).style) === R + "-popover" && (i = R + "-native-popover");
            var l = document.createElement("div"),
                u = R + "-prompt " + i;
            l.setAttribute("class", u), e.backgroundcolor.length > 0 && i != R + "-fab" && (r = r + "background-color: " + e.backgroundcolor + ";"), l.setAttribute("style", r);
            var d = document.createElement("div");
            d.setAttribute("class", R + "-prompt-message");
            var S = document.createElement("img");
            if (S.setAttribute("class", R + "-bell-icon"), S.setAttribute("width", "14"), S.setAttribute("height", "14"), S.setAttribute("src", "https://" + p + "/img/push/icon-ring.svg"), s) {
                var m = document.createElement("span");
                m.setAttribute("class", R + "-link-wrapper"), (L = document.createElement("a")).setAttribute("class", R + "-link"), L.setAttribute("href", B), L.setAttribute("target", "_blank");
                var g = document.createElement("span");
                i === R + "-modal" && (L.setAttribute("style", "color: " + e.textcolor + " !important;"), m.setAttribute("style", "color: " + e.textcolor + " !important;"), g.setAttribute("style", "color: " + e.textcolor + " !important;")), g.innerHTML = Y[n], i != R + "-bar" && (L.innerHTML = a), L.appendChild(g), m.appendChild(L)
            }
            if (i === R + "-native-popover") {
                r = r + "color: " + e.textcolor + " !important;", l.setAttribute("style", r), void 0 !== e.custom && void 0 !== e.custom.prompt_position && (u += " " + R + "-pos-" + e.custom.prompt_position, l.setAttribute("class", u)), (C = document.createElement("div")).setAttribute("class", R + "-native-info-inner " + R + "-table-wrapper");
                var v = document.createElement("div");
                v.setAttribute("class", R + "-cell"), S.setAttribute("src", "https://" + p + e.icon), S.setAttribute("width", "64"), S.setAttribute("height", "64"), v.appendChild(S);
                var f = document.createElement("div");
                f.setAttribute("class", R + "-cell");
                var M = document.createElement("div");
                M.setAttribute("class", R + "-prompt-info " + R + "-prompt-message-text"), M.innerHTML += w, f.appendChild(M), C.appendChild(v), C.appendChild(f)
            } else if (i == R + "-bar") {
                (C = document.createElement("div")).setAttribute("class", R + "-prompt-info " + R + "-prompt-message-text"), C.setAttribute("style", "color: " + e.textcolor + " !important;"), C.innerHTML += w;
                var I = document.createElement("span");
                d.innerHTML += c + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="' + R + '-bell-icon"><use class="' + R + '-bell-path" style="fill: ' + e.textcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" />  </svg>'
            } else if (i == R + "-fab") {
                if ((C = document.createElement("div")).setAttribute("class", R + "-prompt-title " + R + "-prompt-message-text"), e.textcolor.length > 0 && C.setAttribute("style", "color: " + e.textcolor + " !important;"), C.innerHTML = h, (I = document.createElement("div")).setAttribute("class", R + "-prompt-info " + R + "-prompt-message-text"), e.textcolor.length > 0 && I.setAttribute("style", "color: " + e.textcolor + " !important;"), I.innerHTML += w, void 0 !== e.custom && void 0 !== e.custom.prompt_size && "big" === e.custom.prompt_size) {
                    ...
                    y.setAttribute("class", R + "-cell");
                    var O = document.createElement("a");
                    O.innerHTML += '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="' + R + '-bell-icon"><use class="' + R + '-bell-path bell-prompt-fab" style="fill: ' + e.textcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0">' + c + "</use></svg>", O.setAttribute("href", "#"), y.appendChild(O);
                    var A = document.createElement("div");
                    A.setAttribute("class", R + "-cell");
                    ...
                    N.setAttribute("class", R + "-prompt-label"), (L = document.createElement("a")).setAttribute("href", B), L.setAttribute("target", "_blank"), (g = document.createElement("span")).innerHTML = Y[n], L.appendChild(g), N.appendChild(L)
                } else {
                    var x = document.createElement("div");
                    x.setAttribute("class", R + "-prompt-fab " + R + "_notify_prompt"), x.setAttribute("onclick", "oSpP.startSubscription();oSpP.showHintDiv(); return false;"), e.btncolor.length > 0 && x.setAttribute("style", "background-color: " + e.btncolor + " !important;"), x.innerHTML += c + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="' + R + '-bell-icon" ><use class="' + R + '-bell-path bell-prompt-fab" style="fill: ' + e.iconcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" /></svg>'
                }
                void 0 !== e.custom && void 0 !== e.custom.prompt_position && (u += " " + R + "-fab-" + e.custom.prompt_position, l.setAttribute("class", u))
            } else if (i == R + "-modal" || i == R + "-safari") {
                var C;
                (C = document.createElement("div")).setAttribute("class", R + "-prompt-title " + R + "-prompt-message-text"), e.textcolor.length > 0 && C.setAttribute("style", "color: " + e.textcolor + " !important;"), C.innerHTML = h, (I = document.createElement("div")).setAttribute("class", R + "-prompt-info " + R + "-prompt-message-text"), e.textcolor.length > 0 && I.setAttribute("style", "color: " + e.textcolor + " !important;"), I.innerHTML += w, i == R + "-safari" ? (S.setAttribute("src", "https://" + p + e.icon), S.setAttribute("width", "64"), S.setAttribute("height", "64"), d.appendChild(S)) : d.innerHTML += c + '<svg viewBox="0 0 525.153 525.153" width="40" height="40" xmlns:xlink="http://www.w3.org/1999/xlink" class="' + R + '-bell-icon"><use class="' + R + '-bell-path" style="fill: ' + e.textcolor + ' !important;" xlink:href="#sp_bell_icon" x="0" y="0" />  </svg>'
            }
            if (i != R + "-fab") {
                var E = document.createElement("div");
                E.setAttribute("class", R + "-prompt-buttons");
                var j = document.createElement("button");
                j.setAttribute("class", R + "-prompt-btn " + R + "-accept-btn " + R + "_notify_prompt"), j.setAttribute("type", "button"), j.setAttribute("onclick", "oSpP.startSubscription();oSpP.showHintDiv();oSpP.closeCustomPrompt(true); return false;");
                var k = document.createElement("button");
                if (k.setAttribute("class", R + "-prompt-btn " + R + "-disallow-btn"), k.setAttribute("type", "button"), k.setAttribute("onclick", "oSpP.sendPromptStat('prompt_denied');oSpP.closeCustomPrompt(true); return false;"), j.innerHTML = e.allowbtntext, k.innerHTML = e.disallowbtntext, j.setAttribute("style", "background-color:" + e.buttoncolor + " !important;border-color:" + e.buttoncolor + " !important;"), k.setAttribute("style", "color:" + e.buttoncolor + " !important;"), i === R + "-native-popover") {
                    var _ = document.createElement("div");
                    _.setAttribute("class", R + "-table-wrapper");
                    var z = document.createElement("div");
                    z.setAttribute("class", R + "-cell"), s && void 0 !== m && z.appendChild(m);
                    var U = document.createElement("div");
                    U.setAttribute("class", R + "-cell"), U.appendChild(k);
                    var H = document.createElement("div");
                    H.setAttribute("class", R + "-cell"), H.appendChild(j), _.appendChild(z), _.appendChild(U), _.appendChild(H), E.appendChild(_)
            ...
            if (d.appendChild(C), void 0 !== I && null != I && i != R + "-native-popover" && d.appendChild(I), i !== R + "-fab" ? (d.appendChild(E), s && void 0 !== m && i !== R + "-native-popover" && E.appendChild(m), l.appendChild(d)) : void 0 !== e.custom.prompt_size && "big" === e.custom.prompt_size ? (l.appendChild(d), s && void 0 !== N && l.appendChild(N)) : (s && void 0 !== m && d.appendChild(m), l.appendChild(d), l.appendChild(x)), i != R + "-fab") {
                var Q = document.createElement("button");
                Q.setAttribute("class", R + "-prompt-close"), Q.setAttribute("onclick", "oSpP.closeCustomPrompt(false); return false;"), Q.setAttribute("style", "color:" + e.textcolor + " !important;"), Q.innerHTML = "&times;", l.appendChild(Q)
            }
            if (document.body.insertBefore(l, document.body.childNodes[0]), i == R + "-modal") {
                var G = document.createElement("div");
                G.setAttribute("class", R + "-prompt-backdrop"), G.setAttribute("style", "display:none;"), document.body.insertBefore(G, document.body.childNodes[1])
            }
            setTimeout((function() {
        ...
        oSpP.sendPromptStat("prompt_closed"), null !== document.body.querySelector("." + R + "-prompt") && document.body.querySelector("." + R + "-prompt").remove(), oSpP.closePromptHelpText(!0), e || oSpP.putValueToDb("SPIDs", {
            type: "PromptClosed",
            value: j
        })
    }, this.showHintDiv = function() {
        if (J && "chrome" === c.name.toLowerCase()) {
            var e = this.getPushHintDiv();
            e.setAttribute("class", R + "-prompt " + R + "-hint-popover show-prompt " + R + "-secure-mode"), document.body.appendChild(e)
        }
    }, this.hideHintDiv = function() {
        document.getElementsByClassName(R + "-hint-popover").length && document.querySelector("." + R + "-hint-popover").remove()
    }, this.closePromptHelpText = function(e) {
        null !== document.querySelector("." + R + "-backdrop-info") && document.querySelector("." + R + "-backdrop-info").remove(), e ? oSpP.sendPromptStat("prompt_closed") : oSpP.putValueToDb("SPIDs", {
            type: "PromptClosed",
            value: j
        })
    }, this.closePushLabel = function() {
        null !== document.querySelector("." + R + "-bottom-push-label") && document.querySelector("." + R + "-bottom-push-label").remove(), null !== document.querySelector("." + R + "-webpush-label") && document.querySelector("." + R + "-webpush-label").remove()
        ...
        if (parseInt(G) > 0) var t = setInterval((function() {
